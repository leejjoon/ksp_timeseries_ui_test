...
(function() {
  ...
  DataUnit = (function(_super) {
    ...
    DataUnit.swapEndian['E'] = DataUnit.swapEndian['J'];
    ...
    BinaryTable.prototype.setAccessors = function(header) {
      ...
      for (i = _i = 1, _ref2 = this.cols; 1 <= _ref2 ? _i <= _ref2 : _i >= _ref2; i = 1 <= _ref2 ? ++_i : --_i) {
        ...
        _results.push((function(descriptor, count) {
		  ...
		  var ztile_length = _this.ztile[0] * _this.ztile[1];
                  _ref3 = _this.getFromHeap(view, offset, descriptor), arr = _ref3[0], offset = _ref3[1];
                  pixels = new _this.typedArray[_this.algorithmParameters["BYTEPIX"]](ztile_length);
                  Decompress.Rice(arr, _this.algorithmParameters["BLOCKSIZE"], _this.algorithmParameters["BYTEPIX"], pixels, ztile_length, Decompress.RiceSetup);
  ...
  CompressedImage = (function(_super) {
    ...
    CompressedImage.prototype._getRows = function(buffer, nRows) {
      ...
      var frame_length = this.width * this.height;
      var ztile_length = this.ztile[0] * this.ztile[1];
      var nrow_frame = frame_length / ztile_length;
      ...
      while (nRows--) {
        ...
        nTile = nrow_frame - nRows;
        var tile_offset = frame_length - (nRows+1) * ztile_length;
        console.log(nTile, tile_offset);
    ...
    CompressedImage.prototype.getFrame = function(nFrame, callback, opts) {
      ...
      if (this.heap) {
        ...
        var frame_length = _this.width * _this.height;
        var ztile_length = _this.ztile[0] * _this.ztile[1];
        var nrow = frame_length / ztile_length;
        return this.getRows(nFrame*nrow, nrow, callback, opts);
      } else {
